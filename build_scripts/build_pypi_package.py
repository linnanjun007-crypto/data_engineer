#!/usr/bin/env python3
"""
Build and publish script for dataengineer-agent package
"""
...
def test_installation():
    ...
    try:
        result = run_command(
            "python3 -c 'import dataengineer; print(f"DataEngineer version: {datus.__version__}"): {datus.__version__}\")'",
            capture_output=True,
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("🚀 DataEngineer Agent Package Builder")
        print("=" * 40)
