...
IMPACTED_TEST_MAPPING = [
    ("dataengineer/agent/", "tests/unit_tests/agent/"),
    ("dataengineer/api/", "tests/unit_tests/api/"),
    ("dataengineer/cli/", "tests/unit_tests/cli/"),
    ("dataengineer/configuration/", "tests/unit_tests/configuration/"),
    ("dataengineer/models/", "tests/unit_tests/models/"),
    ("dataengineer/storage/", "tests/unit_tests/storage/"),
    ("dataengineer/tools/", "tests/unit_tests/tools/"),
    ("dataengineer/utils/", "tests/unit_tests/utils/"),
    ("ci/", "tests/unit_tests/ci/"),
    # Catch top-level dataengineer/ changes (for example __init__.py or future shared modules)
    # with the full unit suite as a safety net when no narrower prefix applies.
    ("dataengineer/", "tests/unit_tests/"),
]
    ...
    if compare_branch:
        ...
        proc = _run_cmd(
            [
                ...
                "--fail-under=0",
                "--exclude",
                "dataengineer/cli/web/chatbot.py",
                "--exclude",
                "dataengineer/cli/screen/subject_screen.py",
            ],
            DIFF_COVER_TIMEOUT,
            capture_output=True,
            text=True,
