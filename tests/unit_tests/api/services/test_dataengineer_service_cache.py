"""Tests for datus.api.services.dataengineer_service_cache — async LRU cache."""
...
def _mock_service(project_id="p1", has_active=False, fingerprint="fp-default"):
    """Create a mock DataEngineerService."""
    svc = MagicMock()
...
class TestDataEngineerServiceCacheInit:
    ...
    def test_custom_max_size(self):
        ...
        cache = DataEngineerServiceCache(max_size=5)
...
class TestGetOrCreate:
    ...
    async def test_lru_eviction_when_over_capacity(self):
        ...
        cache = DataEngineerServiceCache(max_size=2)
