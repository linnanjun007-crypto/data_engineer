...
from dataengineer.api.services.agent_service import (
    BUILTIN_SUBAGENTS,
...
class TestCreateAgent:
    ...
    async def test_create_agent_success(self, real_agent_config):
        ...
        from dataengineer.api.models.agent_models import CreateAgentInput
...
class TestEditAgent:
    ...
    async def test_edit_agent_not_found(self, real_agent_config):
        ...
        from dataengineer.api.models.agent_models import EditAgentInput
    ...
    async def test_edit_existing_agent(self, real_agent_config):
        ...
        from dataengineer.api.models.agent_models import CreateAgentInput, EditAgentInput
