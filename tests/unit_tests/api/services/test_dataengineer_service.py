"""Tests for datus.api.services.dataengineer_service — per-project service facade."""
...
class TestDataEngineerServiceInit:
    """Tests for DataEngineerService construction."""
    ...
    def test_init_stores_config_and_project_id(self, real_agent_config):
        ...
        svc = DataEngineerService(agent_config=real_agent_config, project_id="test-proj")
    ...
    def test_init_creates_task_manager(self, real_agent_config):
        ...
        svc = DataEngineerService(agent_config=real_agent_config, project_id="p1")
...
class TestDataEngineerServiceLazyProperties:
...
class TestDataEngineerServiceBehavior:
    ...
    def test_config_fingerprint_is_stable(self, real_agent_config):
        ...
        svc1 = DataEngineerService(agent_config=real_agent_config, project_id="p1")
        svc2 = DataEngineerService(agent_config=real_agent_config, project_id="p2")
