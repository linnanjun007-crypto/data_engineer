"""Tests for dataengineer/api/routes/tool_routes.py — direct tool dispatch endpoint."""

from unittest.mock import MagicMock

from dataengineer.api.models.base_models import Result
from dataengineer.api.routes.tool_routes import execute_tool
from dataengineer.tools.func_tool.base import FuncToolResult


def _mock_svc(execute_return=None):
    """Build a mock DataEngineerService with tool service."""
    svc = MagicMock()
