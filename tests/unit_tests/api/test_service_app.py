"""Tests for datus.api.service — FastAPI app creation and DataEngineerAPIService."""
...
class TestDataEngineerAPIServiceInit:
    """Tests for DataEngineerAPIService initialization."""

    def test_init_sets_defaults(self):
        """DataEngineerAPIService starts with empty agents, no config, no task store."""
        args = argparse.Namespace(config="", namespace="default")
        svc = DataEngineerAPIService(args)
        assert svc.agents == {}
...
class TestDataEngineerAPIServiceGenerateTaskId:
