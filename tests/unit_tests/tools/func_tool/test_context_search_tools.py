...
from dataengineer.tools.func_tool import ContextSearchTools
...
def build_context_tools(mock_agent_config):
    def _builder(metric_cfg=None, sql_cfg=None, knowledge_cfg=None):
        ...
        with (
            ...
            patch(
                "dataengineer.tools.func_tool.context_search.MetricRAG.storage.subject_tree", return_value=mock_subject_tree
            ),
        ):
