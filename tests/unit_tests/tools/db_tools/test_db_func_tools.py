"""
Test cases for DBFuncTool class in dataengineer/tools/tools.py
"""
...
from dataengineer.tools.db_tools import BaseSqlConnector, connector_registry
...
class TestDBFuncTool:
    ...
    def test_scoped_tables_loaded_from_agent_config(self, monkeypatch, mock_connector):
        ...
        monkeypatch.setattr("dataengineer.tools.func_tool.database.SchemaWithValueRAG", StubSchemaRAG)
        monkeypatch.setattr("dataengineer.tools.func_tool.database.SemanticModelRAG", StubSemanticRAG)
