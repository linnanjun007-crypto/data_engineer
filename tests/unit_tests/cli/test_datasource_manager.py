...
from dataengineer.cli.datasource_manager import DatasourceManager
...
def mock_console():
    ...
    with patch("dataengineer.cli.datasource_manager.console") as mock_console:
        yield mock_console
...
def mock_detect_db_connectivity():
    ...
    with patch("dataengineer.cli.datasource_manager.detect_db_connectivity") as mock_test:
...
def mock_save_configuration():
    ...
    with patch("dataengineer.cli.datasource_manager.DatasourceManager._save_configuration") as mock_save:
...
def mock_prompt():
    ...
    with (
        patch("dataengineer.cli.datasource_manager.Prompt.ask") as mock_ask,
        patch("dataengineer.cli.datasource_manager.getpass") as mock_getpass,
        patch("dataengineer.cli.datasource_manager.Confirm.ask") as mock_confirm,
    ):
        # Default mocks
