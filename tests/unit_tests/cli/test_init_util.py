...
class TestDatabaseConnectivity:
    ...
    def test_detect_db_connectivity_starrocks_success(self):
        ...
        with patch("dataengineer.tools.db_tools.db_manager.DBManager") as mock_db_manager:
    ...
    def test_detect_db_connectivity_exception(self):
        ...
        with (
            patch("dataengineer.tools.db_tools.db_manager.DBManager") as mock_db_manager,
            patch("dataengineer.cli.init_util.logger") as mock_logger,
        ):
