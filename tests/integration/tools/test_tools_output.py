...
from dataengineer.schemas.node_models import ExecuteSQLInput, OutputInput
...
from dataengineer.tools.output_tools.output import OutputTool
...
class TestBirdDevOutput:
    ...
    def global_config(self, tmp_path, monkeypatch) -> AgentConfig:
        # chdir to tmp_path so the yml's ``home: .dataengineer_test_data`` relative
