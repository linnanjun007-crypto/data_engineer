...
uvx --from dataengineer-agent dataengineer-mcp --datasource <your datasource>
uvx --from dataengineer-agent dataengineer-mcp --datasource <your datasource> --transport http --host 127.0.0.1 --port 8000
# Dynamic Mode: Multi-datasource HTTP/SSE server
uvx --from dataengineer-agent dataengineer-mcp --dynamic --transport http --host 127.0.0.1 --port 8000
uvx --from dataengineer-agent dataengineer-mcp --dynamic --transport sse --host 127.0.0.1 --port 8000

# Or run directly
dataengineer-mcp --datasource <your datasource>
# Dynamic Mode: Multi-datasource HTTP/SSE server
dataengineer-mcp --dynamic --transport http --host 127.0.0.1 --port 8000
dataengineer-mcp --dynamic --transport sse --host 127.0.0.1 --port 8000
```
...
dataengineer-mcp --dynamic --transport sse --port 8000
...
dataengineer-mcp --datasource <your datasource> --transport http --host 0.0.0.0 --port 8000

# SSE mode (for web clients)
dataengineer-mcp --datasource <your datasource> --transport sse --port 8000
```
...
dataengineer-mcp --dynamic --host 0.0.0.0 --port 8000 --transport sse

# Start dynamic server with streamable HTTP mode
dataengineer-mcp --dynamic --host 0.0.0.0 --port 8000 --transport http
```
