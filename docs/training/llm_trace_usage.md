...
```bash
# CLI mode
dataengineer-cli --database spidersnow --save_llm_trace

# Main program mode
python dataengineer/main.py run --database bird_sqlite --task "Query all users" --task_db_name test.db --save_llm_trace

# Benchmark mode
python dataengineer/main.py benchmark --database bird_sqlite --benchmark bird_dev --save_llm_trace
```
...
dataengineer-cli --database local_duckdb --save_llm_trace
```
...
python dataengineer/main.py run --database prod --task "sensitive query" --save_llm_trace
```
...
python dataengineer/main.py run --database bird_sqlite --task "Complex query" --save_llm_trace
```
