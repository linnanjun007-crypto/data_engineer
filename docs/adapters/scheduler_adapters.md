...
DataEngineer Agent supports external schedulers through a plugin-based adapter system. These adapters power the `scheduler` subagent and scheduled job lifecycle operations.
