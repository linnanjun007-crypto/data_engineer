...
DataEngineer Agent supports BI platform integrations through a plugin-based adapter system. These adapters power dashboard creation workflows such as `gen_dashboard` and BI bootstrapping.
