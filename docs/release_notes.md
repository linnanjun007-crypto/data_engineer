...
- **Improved Initialization** - Enhanced `dataengineer-agent init` command with better error handling and setup flow. [#194](https://github.com/Datus-ai/Datus-agent/issues/194)
...
- Added datus-init to initialize the ~/.dataengineer/ directory.
- Included a sample DuckDB database in ~/.dataengineer/sample.
...
- Implemented automatic installation of the MCP server into the dataengineer-mcp directory.
