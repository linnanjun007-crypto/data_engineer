...
The **Builtin Subagent** are specialized AI assistants integrated within the DataEngineer Agent system. Each subagent focuses on a specific aspect of data engineering automation — analyzing SQL, generating semantic models, and converting queries into reusable metrics — together forming a closed-loop workflow from raw SQL to knowledge-aware data products.
...
- **Workspace**: `~/.dataengineer/data/{datasource}/` with subagent-specific subdirectories
...
filepath: "/Users/you/.dataengineer/data/reference_sql/revenue_by_region.yml"
...
Start DataEngineer CLI with `datus --database <datasource>`, and begin with a subagent command:
...
Start DataEngineer CLI with `datus --database <datasource>`, and use the metrics generation subagent:
...
Path: /Users/you/.dataengineer/data/semantic_models/transactions.yml
==========================================================
...
File: /Users/liuyufei/DatusProject/bird/dataengineer/ext_knowledge/bird_sqlite_with_knowledge/sat_school_administration_knowledge.yaml
============================================================
...
The `gen_skill` subagent guides users through creating or optimizing DataEngineer skills. It can inspect existing skills, scaffold new skill directories, edit `SKILL.md`, validate the result, and search prior sessions for usage patterns.
