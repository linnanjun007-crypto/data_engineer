...
Removes an existing MCP server configuration from your `~/.dataengineer/conf/.mcp.json`.
...
- All MCP server definitions are stored in a single JSON file: `~/.dataengineer/conf/.mcp.json`
