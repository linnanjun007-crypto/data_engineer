...
本指南将引导你完成 Slack 机器人的配置，通过 DataEngineer Gateway IM 网关连接到 DataEngineer Agent。Slack 使用 **Socket Mode**，从服务器建立出站 WebSocket 连接 —— 无需公网 URL 或 Webhook 端点。
