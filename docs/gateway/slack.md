...
This guide walks you through setting up a Slack bot that connects to DataEngineer Agent via the DataEngineer Gateway IM module. Slack uses **Socket Mode**, which establishes an outbound WebSocket connection from your server — no public URL or webhook endpoint is required.
...
```json
{
  ...
  "features": {
    "bot_user": {
      "display_name": "DataEngineer Agent",
      "always_online": true
    },
    "app_home": {
...
## Step 5: Configure DataEngineer Agent
