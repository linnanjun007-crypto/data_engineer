...
1. **OpenRouter cache** (`~/.dataengineer/cache/openrouter_models.json`) — richest data including pricing and context lengths, auto-refreshed from the OpenRouter API with an 8-second timeout.
