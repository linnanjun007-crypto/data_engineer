...
- **Agent configuration file**: `agent.yml` is the primary configuration file for both dataengineer-agent and dataengineer-cli
- **Startup priority**:
...
The DataEngineer Agent configuration is the heart of how your system behaves—it governs which models to use, how different components (nodes, workflows, storage, databases, benchmarks) connect, and how queries get processed end-to-end.
...
Additionally, each project directory can have a `.dataengineer/config.yml` override for project-specific model and database selection:
