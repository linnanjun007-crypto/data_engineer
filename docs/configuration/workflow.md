...
Configure workflow orchestration in DataEngineer Agent to define execution plans, node sequences, parallel processing, and sub-workflow composition. Workflows control how nodes are executed to process user queries and generate SQL.
...
DataEngineer Agent provides three built-in workflow plans if you don't configure custom ones:
