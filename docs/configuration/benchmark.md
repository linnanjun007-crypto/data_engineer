...
Configure benchmark datasets to evaluate and test DataEngineer Agent's performance on standardized SQL generation tasks. Benchmarks help measure accuracy, compare different configurations, and validate improvements.

## Supported Benchmarks

DataEngineer Agent currently supports the following benchmark datasets:
