...
- **Default location**: `~/.dataengineer/data/document/<platform>/`.
...
```bash
dataengineer-agent platform-doc \
...
```bash
dataengineer-agent platform-doc --platform starrocks --github-ref 4.0.5
```
