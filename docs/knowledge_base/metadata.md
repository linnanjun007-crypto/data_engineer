...
You can build it using the `dataengineer-agent bootstrap-kb` command:

```bash
dataengineer-agent bootstrap-kb --database <your_datasource> --kb_update_strategy [check/overwrite/incremental]
```
...
```bash
dataengineer-agent bootstrap-kb --database <your_datasource> --kb_update_strategy check
```

### Full Rebuild
```bash
dataengineer-agent bootstrap-kb --database <your_datasource> --kb_update_strategy overwrite
```

### Incremental Update
```bash
dataengineer-agent bootstrap-kb --database <your_datasource> --kb_update_strategy incremental
```
