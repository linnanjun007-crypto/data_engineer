...
from dataengineer.cli.cli_styles import CLR_CURRENT, CLR_CURSOR, SYM_ARROW, print_error, print_warning
...
def _run_sub_application(app: Any) -> Any:
    ...
    When the DataEngineer REPL is running in TUI mode, a persistent
...
def confirm_prompt(console: Console, message: str, default: bool = False) -> bool:
    ...
    :class:`~datus.cli.tui.app.DataEngineerApp` worker thread, where the rich
