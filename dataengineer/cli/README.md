# DataEngineer-CLI User Manual

## Overview

DataEngineer-CLI is a data engineering agent that builds evolvable context for your data system. It combines the power of AI with a modern TUI experience to enhance SQL development efficiency.
...
6. Chat with AI:
````sql
DataEngineer> / Can you explain this query's performance?
...
DataEngineer> !bash ls output
02bd515a.csv
DataEngineer> !bash cat output/02bd515a.csv
...
...
DataEngineer-CLI supports several types of commands, each with its own prefix:
