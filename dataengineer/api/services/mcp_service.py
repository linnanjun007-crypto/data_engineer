...
from dataengineer.api.models.mcp_models import AddServerInput, CallToolInput, ToolFilterInput
from dataengineer.configuration.agent_config import AgentConfig
from dataengineer.tools.mcp_tools.mcp_config import MCPServerConfig, MCPServerType, ToolFilterConfig
...
class MCPService:
    ...
    def _create_manager(agent_config: AgentConfig) -> MCPManager:
        ...
        from dataengineer.tools.mcp_tools.mcp_config import MCPConfig
