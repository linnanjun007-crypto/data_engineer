...
def safe_resolve(base: Path, user_path: str) -> Path:
    """Resolve user_path relative to base; raise DataEngineerException if it escapes base.
    ...
    Raises:
        DataEngineerException: If the resolved path escapes the base directory
    """
