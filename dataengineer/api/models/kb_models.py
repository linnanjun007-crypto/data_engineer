...
class BootstrapKbInput(BaseModel):
    ...
    Mirrors the subset of `dataengineer-agent bootstrap-kb` options exposed by the backend API.
    """
    ...
    schema_linking_type: str = Field(
        ...
        description=(
            ...
            "Expected values follow `dataengineer-agent bootstrap-kb`: `table`, `view`, `mv`, or `full`."
        ),
    )
    catalog: str = Field(
        default="",
