...
import asyncio
from dataengineer.models.base import LLMBaseModel
from dataengineer.schemas import GenSqlOutput
...
export LANGSMITH_PROJECT="dataengineer-agent"
```
...
```python
# dataengineer/models/newmodel_model.py
import os
...
```python
# dataengineer/models/base.py - Add to MODEL_TYPE_MAP
...
```python
# dataengineer/utils/constants.py
class LLMProvider:
    OPENAI = "openai"
    CLAUDE = "claude"
    DEEPSEEK = "deepseek"
...
- **`dataengineer/configuration/agent_config.py`**: Add model validation if needed
- **`dataengineer/cli/`**: Update CLI commands to support the new provider
...
import pytest
from dataengineer.models.newmodel_model import NewModelModel
from dataengineer.configuration.agent_config import ModelConfig
