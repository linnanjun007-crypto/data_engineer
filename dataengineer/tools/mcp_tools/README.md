...
The MCP tools use a JSON config file to persist server configs. The configuration path is fixed at `{agent.home}/conf/.mcp.json` (default: `~/.dataengineer/conf/.mcp.json`).
