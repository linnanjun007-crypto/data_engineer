# DataEngineer Configuration Guide

This directory contains the configuration management system for DataEngineer, handling all aspects of agent behavior, LLM
...
DataEngineer uses a hierarchical YAML configuration file (`agent.yml`) with the following main sections:
